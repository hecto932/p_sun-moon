...
<html class="js no-touch svg inlinesvg svgclippaths no-ie8compat">
	<head>
		...
		<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/front/img/temp/favicon.ico" />
		<link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/front/img/temp/favicon.ico" />
	...
	<body>
		<nav class ="nav_backend top-bar">
			<ul>
				<li class = "name">
					<img src="<?php echo base_url(); ?>assets/back/img/template/logo.png" />
				</li>
