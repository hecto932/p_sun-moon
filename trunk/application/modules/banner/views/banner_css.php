...
.color-1 {
	background:url(<?php echo $banners[1]; ?>) center center ;
}
.color-2 {
	background:url(<?php echo $banners[2]; ?>) center center;
}
.color-3 {
	background:url(<?php echo $banners[3]; ?>) center center;
}
.color-4 {
	background:url(<?php echo $banners[4]; ?>) center center;
}
.color-5 {
	background:url(<?php echo $banners[5]; ?>) center center;
}
...
.jms-arrows span.jms-arrows-prev{
	background: #fff url(/assets/front/img/banner/arrow_left.png) no-repeat 50% 50%;
	left: 0px;
	border-radius: 0px 3px 3px 0px;
}
.jms-arrows span.jms-arrows-next{
	background: #fff url(/assets/front/img/banner/arrow_right.png) no-repeat 50% 50%;
	right: 0px;
