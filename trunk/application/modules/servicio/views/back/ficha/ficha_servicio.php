	<div class="row">
		<div class="twelve columns">
			...
			<dl class="tabs contained ten-up">
				...
				?>
				<dd>
					<a href="#Lang<?php echo $servicio_idioma->id_idioma ?>" title="<?php echo strtolower($idioma[$servicio_idioma->id_idioma]->nombre); ?>">
						
						<i class="foundicon-globe"></i>
						<span> <?php echo lang(strtolower($idioma[$servicio_idioma->id_idioma]->idioma)); ?> </span>
