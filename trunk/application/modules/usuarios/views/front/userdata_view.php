...
<div id="g1-content">
    <div class="g1-layout-inner">
		<form  method="post" action="usuarios/usuarios_front/update_userdata" id="formulario_registro" class="contact-form">
			<div id="g1-content">
				<div id="primary">
					...
					<div id="nombre_div" class="form-row">
						...
						<input id="nombre" type="text" class="u-4" type="text"  size="30" name="nombre" value="<?php echo $this->session->userdata('nombre'); ?>" />
					...
					<div id="email_div" class="form-row">
						...
						<input id="email" type="text" name="email" value="<?php echo $this->session->userdata('email'); ?>" />
					...
					<div id="password_div" class="form-row">
						<label for="password"><?php echo lang('front.registro_label_7'); ?> <em class="meta"><?php echo lang('front.userdata.view.pass'); ?></em></label>
					...
					<div id="repassword_div" class="form-row">
						<label for="repassword"><?php echo lang('front.registro_label_8'); ?> <em class="meta"><?php echo lang('front.userdata.view.pass'); ?></em></label>
					...
					<!-- TELEFONO -->
					<div class="form-row">
						<label for="telefono"><?php echo lang('front.registro_label_2'); ?> <em class="meta"><?php echo lang('front.registro_requerido'); ?></em></label>
						<input type="text" class="u-4" type="text" size="30" name="telefono" value="<?php echo $this->session->userdata('telefono'); ?>" />
					...
					<div id="nacionalidad_div" class="form-row">
						...
						<input type="text" name="nacionalidad" value="<?php echo $this->session->userdata('nacionalidad'); ?>" />
					...
					<div id="direccion_div" class="form-row">
						...
						<textarea name="direccion" rows="5" cols="5"><?php echo $this->session->userdata('direccion'); ?></textarea>
