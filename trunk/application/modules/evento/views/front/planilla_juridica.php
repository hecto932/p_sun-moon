...
<!-------------------------------- DATOS DE CONTACTO -------------------------------->
            ...
            <tr>
                <td colspan="3">
                	<h4 style="color:#0B2161;"><u><?php echo strtoupper(lang('evnt.planilla_factura')); ?></u></h4>
                </td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.insc_razon_soc').': '; ?></strong> <?php echo ucwords($rzn_social); ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.insc_rif_jurid').': '; ?></strong> <?php echo $rif; ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.planilla_email_emp').': '; ?></strong> <?php echo $email_empresa; ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.tlfn_fijo').': '; ?></strong> <?php echo $tlfn_fijo; ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.tlfn_movil').': '; ?></strong> <?php echo $tlfn_movil; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                	<h3 style="color:#0B2161;"><u><?php echo strtoupper(lang('evnt.datos_contacto')); ?></u></h3>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.planilla_nombre').': '; ?></strong> <?php echo ucwords($nombre1.' '.$nombre2.' '.$apellido1.' '.$apellido2); ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.planilla_email').': '; ?></strong> <?php echo $email; ?></td>
            </tr>
            <tr>
                <td colspan="3"><strong style="color:#0B2161;"><?php echo lang('evnt.insc_cargo').': '; ?></strong> <?php echo $cargo; ?></td>
            </tr>
            <tr>
