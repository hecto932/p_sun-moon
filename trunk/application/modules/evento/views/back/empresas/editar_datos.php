<div class="row">
	<div class="twelve columns">
		<form class="custom">
			<fieldset>
				<legend><?php echo lang('empresa_evento.editar')?></legend>
				<div class="row">
					<div class="six columns">
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_input('rif', $empresa->rif, 'class="six" id="rif"')?>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_input('razon_social', $empresa->razon_social, 'class="eleven" id="razon_social"')?>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_input('email', $empresa->email, 'class="eleven" id="email"')?>
							</div>
						</div>
					</div>
					<div class="six columns">
						...
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_input('telefono1', $empresa->telefono1, 'id="telefono1"')?>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_input('telefono2', $empresa->telefono2, 'id="telefono2"')?>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="eight columns">
								<?php echo form_textarea('direccion', $empresa->direccion, 'id="direccion" style="height:80px;"')?>
							</div>
						</div>
					</div>
				</div>
